...
import { ClsQuestionModel, ClsQuestionResponse, ClsQuestion } from 'src/app/Model/question';
import { QuestionSetComponent } from '../../question-set/question-set.component';
import { QuestionService } from 'src/app/Service/question.service';
import { Router } from '@angular/router';
import { Options, CustomStepDefinition, LabelType } from '@m0t0r/ngx-slider';
import { HttpErrorResponse } from '@angular/common/http';
import { ErrorHandlerService } from 'src/app/Service/error-handler.service';

@Component({
  selector: 'app-lines-template',
  templateUrl: './lines-template.component.html',
  styleUrls: ['./lines-template.component.css']
})
export class LinesTemplateComponent implements OnInit {
  ...
  RetrunQuestionSubModuleText(lstQuestion: ClsQuestion,Index : number) : string{
    let lstQuestionResponse = lstQuestion.lstQuestionRes;
    this.TxnSubTypeName = lstQuestionResponse[Index].SubTypeName;
    return this.TxnSubTypeName;
  }
}
